...
class MockErrorMessageRepository: MessageRepository {
    ...
    var errorToThrow: Error = TeamUpError.networkError
...
struct MessageSendingErrorTests {
    ...
    func testMessageTooLong() async throws {
        ...
        // In actual send, this would throw TeamUpError.messageTooLong
    }
    ...
    func testRateLimitErrorWithTime() async throws {
        ...
        let error = TeamUpError.rateLimitExceededWithTime(timeRemaining)
...
struct ImageUploadErrorTests {
    ...
    func testContentNotAllowedWithMessage() async throws {
        let error = TeamUpError.contentNotAllowed("Inappropriate content detected")
...
struct MessageDeletionErrorTests {
    ...
    func testBatchOperationFailed() async throws {
        ...
        let error = TeamUpError.batchOperationFailed(operationId: "delete_all", underlyingError: underlyingError)
...
struct MessageEditingErrorTests {
    ...
    func testEditTimeLimitExceeded() async throws {
        let error = TeamUpError.editTimeLimitExceeded
...
struct OfflineQueueErrorTests {
    ...
    func testMessageQueuedStatus() async throws {
        let error = TeamUpError.messageQueuedForDelivery
    ...
    func testMessageDeliveryFailedRetryable() async throws {
        let error = TeamUpError.messageDeliveryFailed(retryable: true)
    ...
    func testMessageDeliveryFailedNonRetryable() async throws {
        let error = TeamUpError.messageDeliveryFailed(retryable: false)
    ...
    func testNetworkErrorTriggersQueue() async throws {
        let networkError = TeamUpError.noInternetConnection
...
struct ContentValidationErrorTests {
    ...
    func testMessageNotSentError() async throws {
        let error = TeamUpError.messageNotSent
...
struct ErrorRecoveryTests {
    ...
    func testMessageDeliveryFailedRecovery() async throws {
        let errorRetryable = TeamUpError.messageDeliveryFailed(retryable: true)
        #expect(errorRetryable.recoverySuggestion?.contains("automatically") == true)

        let errorNonRetryable = TeamUpError.messageDeliveryFailed(retryable: false)
    ...
    func testContentNotAllowedRecovery() async throws {
        let error = TeamUpError.contentNotAllowed("Test")
        #expect(error.recoverySuggestion != nil)
...
struct ErrorConversionTests {
    ...
    @Test("TeamUpError passes through from() conversion")
    func testTeamUpErrorPassthrough() async throws {
        let originalError = TeamUpError.networkError
        let converted = TeamUpError.from(originalError)
    ...
    func testNSURLErrorConversion() async throws {
        ...
        let converted = TeamUpError.from(nsError)
    ...
    func testUnknownErrorConversion() async throws {
        ...
        let converted = TeamUpError.from(unknownError)
...
struct MockRepositoryErrorTests {
    ...
    func testMockRepositorySendFailure() async throws {
        ...
        mockRepo.errorToThrow = TeamUpError.messageNotSent
    ...
    func testMockRepositoryDeleteFailure() async throws {
        ...
        mockRepo.errorToThrow = TeamUpError.permissionDenied
