...
**File Location:**
```
https://teamup.gg/.well-known/apple-app-site-association
https://teamup.gg/apple-app-site-association
```
...
<array>
    <string>applinks:teamup.gg</string>
    <string>applinks:www.teamup.gg</string>
</array>
```
...
| Route | URL | Purpose |
|-------|-----|---------|
| Home | `https://teamup.gg/` | App home screen |
| Referral | `https://teamup.gg/join/CODE` | Referral signup |
| Profile | `https://teamup.gg/profile/USER_ID` | View user profile |
| Match | `https://teamup.gg/match/MATCH_ID` | View match details |
| Message | `https://teamup.gg/message/MATCH_ID` | Open conversation |
| Email Verify | `https://teamup.gg/verify-email?token=TOKEN` | Verify email |
| Reset Password | `https://teamup.gg/reset-password?token=TOKEN` | Reset password |
| Upgrade | `https://teamup.gg/upgrade` | Premium upgrade |
| Settings | `https://teamup.gg/settings` | App settings |
| Notifications | `https://teamup.gg/notifications` | Notifications |
...
extension AuthService {
    func verifyEmail(withToken token: String) async throws {
        ...
        // Example:
        let url = URL(string: "https://api.teamup.gg/verify-email")!
...
1. Open Notes app
2. Type: `https://teamup.gg/join/TESTCODE`
3. Long press the link
4. Tap "Open in TeamUp"

#### Method 2: Command Line (Simulator)
```bash
xcrun simctl openurl booted "https://teamup.gg/join/TESTCODE"
```
...
xcrun devicectl device process launch --device <DEVICE_ID> \
  --url "https://teamup.gg/join/TESTCODE"
```
...
```bash
curl -v https://teamup.gg/.well-known/apple-app-site-association
```
...
curl https://app-site-association.cdn-apple.com/a/v1/teamup.gg
```
