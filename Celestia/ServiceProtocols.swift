...
protocol AuthServiceProtocol: ObservableObject {
    ...
    func createUser(withEmail email: String, password: String, fullName: String, age: Int, gender: String, gamerTag: String, location: String, country: String, referralCode: String, photos: [UIImage]) async throws
    func signOut()
