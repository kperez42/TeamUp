                        ...
                        ForEach(genderOptions, id: \.self) { option in
                            Button {
                                ...
                                .overlay(
                                    RoundedRectangle(cornerRadius: 12)
                                        .stroke(
                                            gender == option ? Color.blue.opacity(0.5) : Color.gray.opacity(0.2),
                                            lineWidth: 1
                                        )
                                )
                            }
                ...
                VStack(spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        TextEditor(text: $bio)
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 12)
                                    .stroke(bio.isEmpty ? Color.red.opacity(0.5) : Color.blue.opacity(0.2), lineWidth: 1)
                            )
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        TextField("e.g. Los Angeles", text: $location)
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 12)
                                    .stroke(location.isEmpty ? Color.red.opacity(0.5) : Color.blue.opacity(0.2), lineWidth: 1)
                            )
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Menu {
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 12)
                                    .stroke(country.isEmpty ? Color.red.opacity(0.5) : Color.blue.opacity(0.2), lineWidth: 1)
                            )
                        }
        ...
        ScrollView(showsIndicators: false) {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 8) {
                    ...
                    .padding(.vertical, 6)
                    .background(photoImages.count >= 2 ? Color.blue.opacity(0.1) : Color.blue.opacity(0.1))
                    .cornerRadius(20)
                    .padding(.top, 4)
                }
                    ...
                    ForEach(lookingForOptions, id: \.self) { option in
                        Button {
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 12)
                                    .stroke(
                                        lookingFor == option ? Color.blue.opacity(0.5) : Color.gray.opacity(0.2),
                                        lineWidth: 1
                                    )
                            )
                        }
